package br.com.carlosjunior.hexagonalcustomer.architecture;
...
@AnalyzeClasses(packages = "br.com.carlosjunior.hexagonalcustomer")
public class NamingConventionTest {
    ...
    public static final ArchRule config_reside_only_config_package = classes()
            ...
            .should()
            .resideInAPackage("..hexagonalcustomer.config")
